...
- Future:
  ...
  - Note that many students struggled debugging their receiver and the transmitter model at the same time. It wasn't clear which one has the problem.
...
In many cases you will need to change your original HDL code to address the warnings.
