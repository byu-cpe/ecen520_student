...
<!--
Synthesize your design and create a bit file [see the tutorials for synthesis](https://byu-cpe.github.io/ecen320/documentation/vivado-command-line-synthesis/),
[implementation](https://byu-cpe.github.io/ecen320/documentation/vivado-command-line-implementation/), and
[bitgen](https://byu-cpe.github.io/ecen320/documentation/downloading-bitfiles/).
-->
...
Later, you can load the state of your design by using the [`read_checkpoint`](../resources/vivado_command_line.md#create-checkpoint) command.
```read_checkpoint
```
