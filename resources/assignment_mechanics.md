...
1. Check date of submission and compare with the due date

```
git log -n 1 tags/<assignment tag>
```

1. Run the assignment test script (for example, `python3 assignment_check.py --noclean`) without running the clean step
    * review the logs for any warnings and errors
2. Review products of the build script
