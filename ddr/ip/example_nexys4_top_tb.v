...
// Controlling the bi-directional BUS
  ...
  example_nexys4_top # // changed for nexys4
    (
...
//     .RST_ACT_LOW               (RST_ACT_LOW)
   ...
   u_ip_top
    ...
    //  .sys_clk_i            (sys_clk_i),
    .CLK100MHZ            (sys_clk_i), // Nexys4 board clock input
    
      .init_calib_complete (init_calib_complete),
      .tg_compare_error    (tg_compare_error),
      // .sys_rst             (sys_rst)
      .CPU_RESETN             (sys_rst) // Nexys4 board reset signal
     );
