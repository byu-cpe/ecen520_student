...
# 100 ps jitter on input oscillator
...
#set_false_path -to [get_ports { LED17_G } ]
#set_false_path -to [get_ports { LED17_R } ]
...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { tg_compare_error }]; #IO_L24P_T3_RS1_15 Sch=led[1]
