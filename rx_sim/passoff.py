...
def main():
    ...
    tester.add_build_test(repo_test.file_regex_check("sim_rx_115200_even.log", "Simulation done with 0 errors", 
                                                     ...
                                                     error_msg = "rx testbench failed"))
    tester.add_Makefile_rule("synth_rx", ["rx.sv"], ["synth_rx.log"])
    tester.add_Makefile_rule("synth_rx_gray", ["rx.sv"], ["synth_rx_gray.log"])
    ...
    tester.add_build_test(repo_test.file_regex_check("sim_ssd.log", "Error: Display value mismatch", 
                                                     "SSD Display Value Test", error_on_match = True,
                                                     error_msg = "SSD testbench reported a display value mismatch"))
